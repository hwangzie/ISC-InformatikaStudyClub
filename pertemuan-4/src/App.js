        ...
        <div className='bawah'>
          <div className='colitems'>
            ...
            <div className='loginbutton'>
              ...
              </svg> Masuk degan Apple</button>
            </div>

            <div className='divider'></div>

            <div className='username'>
              <input onChange={onChange} value={username} type='email' id='email' placeholder='Phone, email, or username'></input>
            </div>

            <div className='loginbutton black'>
              <button>Next</button>
            </div>
            <div className='loginbutton'>
